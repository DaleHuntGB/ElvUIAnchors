...
function Private:SetupConfig()
    ...
    Private.Config.args.PrivateAuras = BuildFrameLayoutSection(Private.DB.global.PrivateAuras, "PrivateAurasMover", "Private Auras", 10)
    Private.Config.args.ActionBar1 = BuildFrameLayoutSection(Private.DB.global.ActionBar1, "ElvAB_1", "Action Bar 1", 11)
