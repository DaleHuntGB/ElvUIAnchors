...
local function BuildFrameLayoutSection(FrameDB, MoverName, GroupName, TabOrder)
    ...
    Section.args.Enabled = ACH:Toggle("Enable |cFF8080FF" .. GroupName .. "|r Anchor", nil, 1, nil, nil, "full", function() return FrameDB.Enabled end, function(_, value) FrameDB.Enabled = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)

    Section.args.LayoutHeader = ACH:Header("Anchoring", 2)

    Section.args.AnchorFrom = ACH:Select("Anchor From", nil, 3, Private.ANCHOR_POINTS, nil, "full", function() return FrameDB.Layout[1] end, function(_, value) FrameDB.Layout[1] = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)
    Section.args.AnchorParent = ACH:Input("Anchor Parent", nil, 4, nil, "full", function() return FrameDB.Layout[2] end, function(_, value) FrameDB.Layout[2] = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)
    Section.args.AnchorTo = ACH:Select("Anchor To", nil, 5, Private.ANCHOR_POINTS, nil, "full", function() return FrameDB.Layout[3] end, function(_, value) FrameDB.Layout[3] = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)
    Section.args.XOffset = ACH:Range("X Offset", nil, 6, { min = -2000, max = 2000, step = 1 }, "full", function() return FrameDB.Layout[4] end, function(_, value) FrameDB.Layout[4] = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)
    Section.args.YOffset = ACH:Range("Y Offset", nil, 7, { min = -2000, max = 2000, step = 1 }, "full", function() return FrameDB.Layout[5] end, function(_, value) FrameDB.Layout[5] = value Private:UpdateMovers(FrameDB.Enabled, MoverName, table.concat(FrameDB.Layout, ",")) end)
